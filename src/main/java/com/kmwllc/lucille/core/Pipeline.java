...
public class Pipeline {
  ...
  public static Pipeline fromConfig(List<? extends Config> stages, String metricsPrefix)
      throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException,
          InvocationTargetException, InstantiationException, StageException, PipelineException {
  ...
  /**
   * Passes a Document through the designated sequence of stages and returns a list containing the
   * input Document as the first element, along with any child documents generated.
   *
