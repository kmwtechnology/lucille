 ...
 *
 * <p>Documents should be passed to a designated Publisher to make them available for downstream
 * processing.
 *
 * <p>Implementations of Connector should provide a constructor that takes a Config as the only
...
public interface Connector extends AutoCloseable {
  ...
  static List<Connector> fromConfig(Config config)
      throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException,
          InvocationTargetException, InstantiationException, ConnectorException {
