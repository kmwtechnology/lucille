 ...
 *
 * <p>This abstract class provides some base functionality which should be applicable to all Stages.
 *
 * <p>Config Parameters:
 *
 * <p>- conditional_fields (List<String>, Optional) : The fields which will be used to determine if
 * this stage should be applied. Turns off conditional execution by default. - conditional_values
 * (List<String>, Optional) : The values which we will search the conditional fields for. Should be
 * set iff conditional_fields is set. - conditional_operator (String, Optional) : The operator to
 * determine conditional execution. Can be 'must' or 'must_not'. Defaults to must.
 */
