...
public class Print extends Stage {
  ...
  public Print(Config config) {
    ...
    this.shouldLog = !config.hasPath("shouldLog") || config.getBoolean("shouldLog");
    this.excludeFields =
        config.hasPath("excludeFields") ? config.getStringList("excludeFields") : null;
    this.overwriteFile = !config.hasPath("overwriteFile") || config.getBoolean("overwriteFile");
  }
