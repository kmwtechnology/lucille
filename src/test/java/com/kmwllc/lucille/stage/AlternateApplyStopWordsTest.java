...
public class AlternateApplyStopWordsTest {

  StageFactory factory = StageFactory.of(AlternateApplyStopWords.class);

  @Test
  public void noFieldsTest() throws StageException {
    Stage stage = factory.get("AlternateApplyStopWordsTest/nofields.conf");
  ...
  public void fieldsTest() throws StageException {
    Stage stage = factory.get("AlternateApplyStopWordsTest/fields.conf");

    Document doc1 = new Document("doc1");
    doc1.setField("input1", "is there a stopword about turn");
  ...
  public void splitOnWhiteSpaceTest() throws StageException {
    ...
    Document doc1 = new Document("doc1");
    doc1.setField("input1", "the faucet doesn't turn");
