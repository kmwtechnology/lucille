...
public class MatchQueryTest {
  ...
  public void testMatchQueryStage() throws Exception {
    ...
    assertTrue(
        "Two queries should have matched document d3. ",
    ...
    assertTrue(
        "d3 should match not_asia", d3.getStringList(matchedQueriesField).contains("not_asia"));
    ...
    assertTrue(
        "One query should have matched document d5. ",
