...
/**
 * Utility for instantiating stages from with a test. Provide various get methods that handle the details of acquiring a Config,
 * creating a stage instance with the Config, and then starting the stage. The stage is returned in a "ready to use" condition.
 */
