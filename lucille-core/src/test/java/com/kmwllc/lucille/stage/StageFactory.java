 ...
 * details of acquiring a Config, creating a stage instance with the Config, and then starting the
 * stage. The stage is returned in a "ready to use" condition.
 */
public class StageFactory {
  ...
  /**
   * Creates a new instance of the stage with a Config loaded from the given resource path, starts
   * it, and returns it.
   */
  ...
  /**
   * Creates a new instance of the stage with a Config built from the provided Map, starts it, and
   * returns it.
   */
