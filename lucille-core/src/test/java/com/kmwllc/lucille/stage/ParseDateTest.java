...
public class ParseDateTest {
  ...
  public void testInvalidTimeZoneId() {
    Throwable exception = assertThrows(StageException.class, () -> factory.get("ParseDateTest/invalidConfig.conf"));
  ...
  @Test
  public void testParseDateWithTimeZoneAndHMS() throws StageException {
    ...
    configValues.put("source", List.of("date"));
    configValues.put("dest", List.of("output"));
    configValues.put("format_strs", List.of("yyyy-MM-dd'T'HH:mm:ssZ"));
...
//        "Australia/Brisbane", "2021-02-01T00:00:00Z"
    ...
    for (Map.Entry<String, String> entry: timeZoneToFormattedDate.entrySet()) {
      ...
      // create a document with a date field
      Document doc = Document.create("doc");
      doc.setField("date", "2021-02-02T00:00:00Z");
  ...
  public void testTemp() {
    String stringDate = "2021-02-02T00:00:00Z";
