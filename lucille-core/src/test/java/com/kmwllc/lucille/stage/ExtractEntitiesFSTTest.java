...
public class ExtractEntitiesFSTTest {
  ...
  public void testStartOfStringBoundary() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/startOfString.conf");
  ...
  public void testEndOfStringBoundary() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/endOfString.conf");
  ...
  public void testPunctuationBoundaries() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/punctBoundaries.conf");
  ...
  public void testLetterOnRightBlocks() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/letterRightBlocks.conf");
  ...
  public void testDigitOnRightDoesNotBlock() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/digitRightOk.conf");
  ...
  public void testDigitOnlyInsideNumber() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/digitInside.conf");
  ...
  public void testLetterOnLeftBlocks() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/letterLeftBlocks.conf");
  ...
  public void testDigitOnLeftDoesNotBlock() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/digitLeftOk.conf");
  ...
  public void testApostropheBoundary() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/apostropheBoundary.conf");
  ...
  public void testHyphenBoundary() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/hyphenBoundary.conf");
  ...
  public void testSlashBoundary() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/slashBoundary.conf");
  ...
  public void testUnderscoreBoundary() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/underscoreBoundary.conf");
  ...
  public void testPunctPeriodCommaBoundary() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/punctPeriodComma.conf");
  ...
  public void testEmojiBoundary() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/emojiBoundary.conf");
  ...
  public void testCjkBoundary() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/cjkBoundary.conf");
  ...
  public void testCaseSensitiveDefault() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/caseSensitiveDefault.conf");
  ...
  public void testIgnoreCaseTrue() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/ignoreCaseTrue.conf");
  ...
  public void testNoCrossPunctuationForMultiword() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/noCrossPunct.conf");
  ...
  public void testExactSpacesMultiword() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/exactSpaces.conf");
  ...
  public void testOverlapsEmitAll() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/overlapsEmitAll.conf");
  ...
  public void testOverlapsEmitLongestOnly() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/overlapsLongest.conf");
  ...
  public void testStopOnHit() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/stopOnHit.conf");
  ...
  public void testUsePayloadsWithEntityField() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/usePayloadsWithEntity.conf");
  ...
  public void testManySourcesOneDestOrder() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/manySourcesOneDest.conf");
  ...
  public void testOneToOneSourceDest() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/oneToOne.conf");
  ...
  public void testTrimAsciiSpacesInDict() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/trimSpaces.conf");
  ...
  public void testDuplicateKeysFirstWins() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/dupKeysFirstWins.conf");
  ...
  public void testMalformedEntryIgnored() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/malformedIgnored.conf");
  ...
  public void testUtf8NonAsciiTerm() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/utf8NonAscii.conf");
  ...
  public void testMultiDictFirstWins() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/multiDictFirstWins.conf");
  ...
  public void testPunctuationInKey() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/punctInKey.conf");
  ...
  public void testApostropheInKey() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/apostropheInKey.conf");
  ...
  public void testSubstringInsideWordNoMatch() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/substringNoMatch.conf");
  ...
  public void testOffByOneNearMiss() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/offByOne.conf");
  ...
  public void testLadderPrefixesEmitAll() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/ladderEmitAll.conf");

    Document doc = Document.create("doc37");
    doc.setField("input1", "a a a!");
    stage.processDocument(doc);

    assertEquals(List.of("X1","X2","X3","X1","X2","X1"), doc.getStringList("output"));
  }

  @Test
  public void testLadderPrefixesLongestOnly() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/ladderLongest.conf");
  ...
  public void testLaterStartAfterDeadPrefix() throws Exception {
    Stage stage = factory.get("ExtractEntitiesFSTTest/laterStartAfterDeadPrefix.conf");
