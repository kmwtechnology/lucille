...
public class DictionaryManagerTest {
  ...
  public void testDictionaryInitializedOnceOnly() throws StageException {
    Map<String, String[]> dict1 =
        DictionaryManager.getDictionary("classpath:DictionaryLookupTest/dictionary.txt", false);
    ...
    Map<String, String[]> dict3 =
        DictionaryManager.getDictionary("classpath:DictionaryLookupTest/dictionary.txt", true);
