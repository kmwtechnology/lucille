 ...
 *
 * <p>An Indexer needs to 1) receive Documents that are ready to be indexed, and 2) send Events
 * indicating the status of the Documents being indexed.
 *
 * <p>An Indexer also needs to communicate with a destination system like Solr or Elasticsearch but
