...
/**
 * Renames a given set of source fields to a given set of destination fields. You must specify the same number of source and
 * destination fields.
 *
 * <p>Config Parameters:
 *
 * <p>- fieldMapping (Map<String, String>) : A 1-1 mapping of original field names to new field
 * names. - update_mode (String, Optional) : Determines how writing will be handling if the destination field is already populated.
