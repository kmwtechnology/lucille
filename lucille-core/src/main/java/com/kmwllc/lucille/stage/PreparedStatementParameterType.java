...
public enum PreparedStatementParameterType {
  ...
  public static PreparedStatementParameterType getType(String type) throws IllegalArgumentException {
    switch (type) {
      case "String":
        return STRING;
      case "Integer":
      ...
      case "Date":
        return DATE;
      default:
        throw new IllegalArgumentException("type " + type + " is not a valid prepared statement parameter.");
    }
  }
}
