...
- OpenSearch URL: `https://34.138.97.13:9200`
- OpenSearch Dashboards URL: `https://34.138.97.13:5601`
- Username: `admin`
...
curl -k -X GET "https://34.138.97.13:9200/lucille_code_vectors/_count?pretty" -u admin:StrongPassword123!

# View a sample of documents 
curl -k -X POST "https://34.138.97.13:9200/lucille_code_vectors/_search?pretty" \
