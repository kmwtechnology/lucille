...
For how to configure connectors — common parameters, config syntax, and the full catalogue of built-in connectors — see [Connectors]({{< relref "docs/ingest-design/connectors" >}}) in the Ingest Designer Guide.
