...
5. Sends lifecycle events (SUCCESS, FAIL, DROP, CREATE) to the Publisher via the event queue.
...
| `SUCCESS` | A document is successfully processed and delivered to the Indexer. |
